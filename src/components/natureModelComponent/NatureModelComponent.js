...
class NatureModelComponent extends Component {
    componentDidMount() {
    ...
    render() {
        ...
        return (
            <ModelSlider category={'Nature'} models={nature}></ModelSlider>
        )
    }
}
...
export default connect(mapStateToProps)(NatureModelComponent)